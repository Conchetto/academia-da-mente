...
?>
	...
	$thumb = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'full' ); ?>
		<div class="single-post-back" style="background-image: url('<?php echo esc_url( $thumb['0'] ); ?>');">
	<?php elseif ( get_field( 'default_background', 'option' ) ) : $dbackground = get_field( 'default_background', 'options' ); ?>
		<div class="single-post-back" style="background-image: url('<?php echo esc_url( $dbackground ); ?>');">
	<?php else : ?>
		<div class="single-post-back-no">
	<?php endif; ?>
	<div class="single-header-v5">
...
<div id="primary" class="content-area sing-template-5">

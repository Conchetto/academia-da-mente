...
<div id="primary" class="page-content-area">
	<main id="main" class="page-site-main">
		<div class="edit-dialog">
			<h5 class="dialog-title"><span><?php esc_attr_e( 'Editar Perfil', 'king' ); ?></span></h5>
			<form action="" class="edit-profile" method="post" enctype="multipart/form-data" autocomplete="off">

				<div class="king-form-group">
					<label for="name-edit"><?php esc_attr_e( 'seu login', 'king' ); ?></label>
			...
			<div class="king-form-group">
					<label for="password-edit"><?php esc_attr_e( 'senha', 'king' ); ?></label>
					<input type="password" id="password-edit" class="bpinput" password-edit" autocomplete="off" maxlength="50" >
			</div>
			...
			<div class="king-form-group">
				<label for="password-edit"><?php esc_attr_e( 'confirme a senha', 'king' ); ?></label>
				<input id="confirm_pass" class="bpinput" type="password"  value="" name="confirm-pass" autocomplete="off" maxlength="50" >
		</div>
	...
	<div class="king-form-group">
		<label for="firstname-edit"><?php esc_attr_e( 'seu nome', 'king' ); ?></label>
...
<div class="king-form-group">
		<label for="lastname-edit"><?php esc_attr_e( 'seu sobrenome', 'king' ); ?></label>
...
<div class="king-form-group">
		<label for="edit-about"><?php esc_attr_e( 'Sobre você', 'king' ); ?></label>
...
<p>
		<input type="submit" id="king-submitbutton" class="king-submit-button" name="save-edit" value="Salvar">
</p>
</form>
</div>
</main>

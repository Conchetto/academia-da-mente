...
class King_Hot_Widget extends WP_Widget {
	...
	/**
	 * Sets up a new Hot Posts widget instance.
	 *
	 * @since 2.8.0
	 * @access public
	 */
	...
	/**
	 * Outputs the content for the current Hot Posts widget instance.
	 *
	 * @since 2.8.0
	 * @access public
	 *
	...
	/**
	 * Handles updating the settings for the current Hot Posts widget instance.
	 *
	 * @since 2.8.0
	 * @access public
	 *
	...
	/**
	 * Outputs the settings form for the Hot Posts widget.
	 *
	 * @since 2.8.0
	 * @access public
	 *
